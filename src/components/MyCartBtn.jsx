...
export default function MyCart({itemList, setItemList}) {
    ...
    if (itemList.length < 1) {
        return (
            <div style={{width:"100%", backgroundColor:"rgb(255, 245, 198)", borderTop:"1px solid black", margin:"auto",
        ...
        return (
            <div className='mycart' style={{width:"100%", height:"100vh", backgroundColor:"rgb(255, 245, 198)", borderTop:"1px solid black", margin:"auto",
            display:"flex", flexDirection:'column', justifyContent:"flex-start", alignItems:"center"}}>
                <div style={{height:'150px', width:'100%', boxSizing:'border-box', flexDirection:'row', paddingBottom:'30px' , borderBottom:'1px solid black'}}>
                    <h3 style={{margin:'0'}}>YOUR CART</h3>
                    <p style={{fontSize:"1.3rem", fontWeight:"bold", margin:'0'}}>총 금액: {totalPrice}</p>
                    <button style={{margin:'0'}}>구매하기</button>
                </div>
                <ul
